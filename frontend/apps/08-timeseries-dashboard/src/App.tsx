/**
 * Time-Series DB UI - Example 8: Time-Series DB (1M+ points/sec)
 * High-speed metrics storage
 */
    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-neutral-900">Time-Series DB</h1>
          <p className="text-sm text-neutral-600">Example 8: Time-Series DB (1M+ points/sec)</p>
        </div>
      </header>
