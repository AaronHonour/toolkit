/**
 * Kappa Architecture UI - Example 6: Kappa Architecture (500K+ events/sec)
    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-neutral-900">Kappa Architecture</h1>
          <p className="text-sm text-neutral-600">Example 6: Kappa Architecture (500K+ events/sec)</p>
        </div>
      </header>
