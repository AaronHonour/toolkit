/**
 * REST API Client UI - Example 1: High-Performance REST API (445K RPS)
    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-neutral-900">REST API Client</h1>
          <p className="text-sm text-neutral-600">Example 1: High-Performance REST API (445K RPS)</p>
        </div>
      </header>
