/**
 * Data Export UI - Example 5: Data Export (10M records/60s)
    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <p className="text-sm text-neutral-600">Example 5: Data Export (10M records/60s)</p>
        </div>
      </header>
      ...
      <footer className="mt-12 border-t bg-white">
        <div className="max-w-7xl mx-auto px-4 py-6 text-sm text-neutral-600">
          <span className="font-semibold">Backend:</span> localhost:8004
        </div>
      </footer>
    </div>
  );
