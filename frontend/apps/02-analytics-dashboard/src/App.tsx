/**
 * Real-Time Analytics UI - Example 2: Real-Time Analytics (1M+ events/sec)
 * Live event processing and metrics
 */
    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-neutral-900">Real-Time Analytics</h1>
          <p className="text-sm text-neutral-600">Example 2: Real-Time Analytics (1M+ events/sec)</p>
        </div>
      </header>
      ...
      <footer className="mt-12 border-t bg-white">
        <div className="max-w-7xl mx-auto px-4 py-6 text-sm text-neutral-600">
          <span className="font-semibold">Backend:</span> localhost:8001
        </div>
      </footer>
    </div>
  );
